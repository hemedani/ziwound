...
export const REPORT_FIELDS: DeclarationField[] = [
  ...
  { name: "hostileCountryIds", type: "array", required: false },
  { name: "attackedCountryIds", type: "array", required: false },
  { name: "attackedProvinceIds", type: "array", required: false },
  { name: "attackedCityIds", type: "array", required: false },
...
export const REPORT_STEPS: StepDefinition[] = [
  ...
  },
  {
    ...
    fields: ["location", "address", "hostileCountryIds", "attackedCountryIds", "attackedProvinceIds", "attackedCityIds"],
  },
  {
    step: 4,
    title: "Documents",
