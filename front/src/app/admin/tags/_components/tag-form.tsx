    ...
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-5">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-offwhite">{t("tagName") || "Tag Name"}</FormLabel>
                  <FormControl>
                    <Input
                      placeholder={t("enterTagName") || "e.g. Urgent"}
                      {...field}
      ...
      <div className="lg:col-span-2">
        <div className="lg:sticky lg:top-6 space-y-4">
          <TagPreview icon={watchIcon} name={watchName} color={watchColor} />
        </div>
      </div>
    </div>
  );
