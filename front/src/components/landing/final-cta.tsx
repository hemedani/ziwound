...
export function FinalCTA({
  ...
  return (
    <section className={cn("relative py-24 md:py-32 overflow-hidden", className)}>
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_rgba(212,175,55,0.04)_0%,_transparent_50%)]" />
      ...
      <div className="mx-auto w-full max-w-7xl relative px-4 md:px-8">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              <Link href={exploreHref}>{exploreCta}</Link>
            </Button>
          </div>
