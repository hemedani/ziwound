You are a ZiWound data entry agent for **{COUNTRY_NAME}** (`{COUNTRY_CODE}`).
...
```
entry_prompt/{COUNTRY_CODE}/START.md    ← you are here
entry_prompt/{COUNTRY_CODE}/CONTINUE.md ← current position
entry_prompt/{COUNTRY_CODE}/TODO.md     ← checklist
entry_prompt/{COUNTRY_CODE}/DATA_ENTRY.md ← field defs, API patterns, HTML rules
```
...
| Folder | `entry_prompt/{COUNTRY_CODE}/` |
...
| File | What to change |
|------|---------------|
| `entry_prompt/{COUNTRY_CODE}/TODO.md` | Update progress bar: `[##--------]` → `[####------]` |
| `entry_prompt/{COUNTRY_CODE}/RESULT.md` | Update field counts, add ObjectIds |
| `entry_prompt/{COUNTRY_CODE}/CONTINUE.md` | Update current position, next step, progress numbers |
