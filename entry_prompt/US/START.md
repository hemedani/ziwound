You are a ZiWound data entry agent for the **United States** (`US`).
...
```
entry_prompt/US/START.md       ← you are here
entry_prompt/US/CONTINUE.md    ← current position
entry_prompt/US/TODO.md        ← checklist
entry_prompt/US/DATA_ENTRY.md  ← field defs, API patterns, HTML rules
```
...
### ✅ Complete (12 provinces, 31 cities — all 10/10)
California, Texas, New York, Illinois, Virginia, Washington DC, Georgia, Pennsylvania, Florida, Ohio, Michigan, Colorado, Alabama, Alaska, Arizona, Arkansas, Connecticut

### 🔄 Pending (39 provinces — need creation + 10 fields each)
Delaware, Hawaii, Idaho, Indiana, Iowa, Kansas, Kentucky, Louisiana, Maine, Maryland, Massachusetts, Minnesota, Mississippi, Missouri, Montana, Nebraska, Nevada, New Hampshire, New Jersey, New Mexico, North Carolina, North Dakota, Oklahoma, Oregon, Rhode Island, South Carolina, South Dakota, Tennessee, Utah, Vermont, Washington, West Virginia, Wisconsin, Wyoming + their cities

**⚠️ Half-finished:** Resume from **Delaware** (not yet created). Do NOT restart.
...
- Cover the **full historical scope** — from indigenous displacement through modern conflicts
...
| File | What to change |
|------|---------------|
| `entry_prompt/US/TODO.md` | Update progress bar: `[##--------]` → `[####------]` |
| `entry_prompt/US/RESULT.md` | Update field counts, add ObjectIds |
| `entry_prompt/US/CONTINUE.md` | Update current position, next step, progress numbers |
...
<h4>1769: First Spanish Mission</h4><p>Description with specific details...</p>
```
...
## 11. Half-Finished Warning

The US was **left half-finished**. 12 provinces + 31 cities are complete. Resume from **Delaware** — create the province, then its cities, then fill 2 fields at a time. Do NOT restart from the beginning.
