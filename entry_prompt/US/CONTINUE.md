# United States — Continuation Guide

> Reading order: `CONTINUE.md` → `TODO.md` → `DATA_ENTRY.md`
...
## Phase 2 🔄 Remaining (39 provinces)
...
See `entry_prompt/US/RESULT.md` for the full ObjectId reference.

> **Update this file after every microstep:** reflect current province/city and field progress.
